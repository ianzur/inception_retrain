...
video_directory = "/home/raphy/projects/vmi/opencv/raw_videos"
...
def label(file: str, path: str):
    ...
    you may remove the random bit (just 2 lines in the beginning of the for loop)
    """
...
def main():
    ...
    print("{} images classified.".format(total))
    return
